 ...
 */
 ...
 class SMS{
    ...
    static public function sendsmstouser($usermessage){
            ...
            $content ="【广深行讯通】亲爱的".$usermessage['passenger_name'].",您成功预定了".$usermessage['purchase_quantity']."张从".$usermessage['start_site']."到".$usermessage['reach_site']."，车牌号为".
                      $usermessage['bus_plate_number']."，时间为".$usermessage['date']." ".$usermessage['time']."的车票。请您提前20分钟到指定地点上车，如有问题，请联系".$usermessage['service_phone']."，感谢您信任我们！";//要发送的短信内容
    ...
    static public function sendsmstomanager($managermessage){
            ...
            $content ="【广深行讯通】乘客".$managermessage['passenger_name']."成功预定了".$managermessage['purchase_quantity']."张从".$managermessage['start_site']."到".$managermessage['reach_site']."，车牌号为".
                      $managermessage['bus_plate_number']."，时间为".$managermessage['date']." ".$managermessage['time']."的车票。";//要发送的短信内容
    ...
    static public function sendSmsToUserFordivision($businfo){
            ...
            $content ="【广深行讯通】亲爱的乘客，由于受车队编排，天气等原因，您所预订的车牌号为 ".$businfo['plate_number']."的".$businfo['purchase_quantity']."张票的路线停运，对您造成不便我们深感抱歉，敬请谅解。如有其它疑问请咨询：13822558552。";//要发送的短信内容
