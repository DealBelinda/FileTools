...
/**
 * Created by OnlyLoveForBelinda on 2016/10/11.
 */
public class FileTools {
    ...
    private static void getAllFileType()
    {
        ...
        FILE_TYPE_MAP.put("java", "7061636B");
        FILE_TYPE_MAP.put("jsp", "3C254020");
        FILE_TYPE_MAP.put("exe", "4D5A9000");
    }
    ...
    public static String getFileType(File file) {
        ...
        try {
            ...
            // 如果不是上述类型，则判断扩展名
            if (fileExtendName == null || fileExtendName.equals("zip")) {
    ...
    private static String getOfficeFileType(FileInputStream fileInputStream){
        ...
        try {
            ...
            System.out.println(flagString.toLowerCase());
    ...
    public static void main(String[] args)
    {
        ...
        File file = new File("C:/Users/OnlyLoveForBelinda/Desktop/2345PdfReader_v6.3.txt");
        FileInputStream is;
        try{
            is = new FileInputStream(file);
            byte[] b = new byte[16];
